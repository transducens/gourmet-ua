                ...
                if self.surface_condition_tags:
                    ...
                    if self.tag_feedback_encoder:
                        ...
                        if len(self.incremental_states[model]) == 0:
                            ...
                            prev_decoder_states=sf_decoder_out[2][0].unsqueeze(1)
                        else:
                            #shape: (bsz,hidden_size)
                        ...
                        if model.apply_transformation_input_b:
                            prev_decoder_states=model.linear_transf_input_b(prev_decoder_states)
...
>>>>>>> eff714de2ebd0bb0fe12407f8a6995d18c12c400
